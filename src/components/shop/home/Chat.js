...
const systemMessage = {
    "role": "system", "content": "Explain things like you're talking to the customer who buys the product from online papad shop."
}

function Chat() {
    const [messages, setMessages] = useState([
        {
            message: "Hello, I'm Assistant! Ask me anything!",
            sentTime: "just now",
            sender: "ChatGPT"
        }
    ]);
